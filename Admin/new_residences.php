...
<body>
        ...
        <ul class="sidenav">
            <div class="admin">
                <li class="logo-profile">
                    <img src="logo.png" alt="Profile Picture" class="logo-profile-photo"><br>

                </li>
                <li class="text-profile">
            ...
            <div class="tools">
                ...
                <li class="sidebar-active"><a href="new_residences.php" style="text-decoration: none;">New Residences </a></li>
    ...
    <section class="main">
        ...
        <form class="row g-3 needs-validation" novalidate action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-3">
                <label for="contnum" class="form-label">Place of Birth</label>
                <input type="text" class="form-control" id="contnum" required>
                <div class="invalid-feedback">
