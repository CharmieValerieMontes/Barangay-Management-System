...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == "add") {
    ...
    $stmt = $conn->prepare("INSERT INTO blotter_entries (first_name, last_name, age, address, accusation, status) VALUES (?, ?, ?, ?, ?, 'Unsettled')");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == "update") {
    ...
    $stmt = $conn->prepare("UPDATE blotter_entries SET status = ? WHERE id = ?");
...
$result = $conn->query("SELECT * FROM blotter_entries");
